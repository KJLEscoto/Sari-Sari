...
@php
    $classes =
        $active ?? false
            ? 'inline-flex items-center px-5 pt-1 border-b-2 border-gray-900 text-sm font-medium leading-5 text-gray-900 focus:outline-none focus:border-gray-400 transition duration-150 ease-in-out'
