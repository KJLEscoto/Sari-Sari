<nav x-data="{ open: false }" class="bg-white sticky top-0 z-50 shadow">
    <!-- Primary Navigation Menu -->
    <div class="max-w-screen-2xl mx-auto 2xl:px-0 px-5">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-0 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('cashier.customer')" :active="request()->routeIs('cashier.customer*')">
                        {{ __('Customer') }}
                    </x-nav-link>
                    <x-nav-link :href="route('cashier.sales')" :active="request()->routeIs('cashier.sales*')">
                        {{ __('Sales') }}
                    </x-nav-link>
                </div>
            </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <x-dropdown-link x-data="" class="text-red-500 cursor-pointer"
                ...
                <x-modal name="confirm-logout">
                    <form method="POST" action="{{ route('logout') }}">
                        ...
                        <div class="p-6">
                            <h2 class="text-lg font-medium text-gray-900">Are you sure you want to log out?</h2>
